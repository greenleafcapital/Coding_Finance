...
Python has a module called `pandas-datareader` which is used for downloading financial data from yahoo. You can install it by typing the command `pip install pandas-datareader` in your terminal/command promt (update as of 2019 this is no longer true, use the fix-yahoo-finance module).
