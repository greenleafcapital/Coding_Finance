...
### Dowloading the stock price for Netflix
...
We already have the daily and monthly returns data for Netflix. Now we we will calculate the daily and monthly mean and standard deviations of the returns. We will use **mean()** and **std()** fucntions for our purpose.
...
## Calculating the correlation and covariance usning pandas
