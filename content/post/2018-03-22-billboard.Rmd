...
Based on our calculations the present value of the billboard is about 78553.44. The offer to buy this investment opportunity is \$70000, so our net present value (NPV) is `r round(pv1 - 70000,2)`. Since we have a positive NPV, we can conclude that this is a good deal if interest rate is 5%. 
